...
import { } from "./index";
import { drawOrWin, validateWinHuman, validateWinPC } from "./validateWin";
...
export function put1():void {
 ...
 export function put2():void {
  ...
  export function put4():void {
   ...
   export function computerSet():void {
    ...
    console.log(enemyChoice)
      ...
      else if(feldnr1 ===enemyChoice || feldnr3=== enemyChoice || feldnr2 === enemyChoice || feldnr4 === enemyChoice || feldnr5 === enemyChoice || feldnr6 === enemyChoice
        || feldnr7 === enemyChoice || feldnr8 === enemyChoice || feldnr9 === enemyChoice){
  ...
  function checkIfRow(){
    if((checkVar1&&checkVar2)===true&& enemySet3===false&& feld3===false){
      enemyChoice=felder[getRandomInt(1,2)]
    ...
    else if((checkVar2&&checkVar3)===true && enemySet5===false && feld5===false)
    {
      if(enemyChoice === 1){
      app5.innerHTML ="O"
      enemySet5=true;
    ...
    else if((checkVar7&&checkVar8)===true && enemySet9===false && feld9===false){
      if(enemyChoice === 1)
      {
      app9.innerHTML = "O"
      enemySet9=true;
    ...
    else if((checkVar1&&checkVar4)===true && enemySet7===false && feld7===false){
      if(enemyChoice=== 1){
      app7.innerHTML = "O"
      enemySet7=true;
      validateWinPC()
    ...
    else if((checkVar2&&checkVar5)===true && enemySet8===false && feld8===false){
      app8.innerHTML = "O"
      enemySet8=true;
      validateWinPC()
    }

    else if((checkVar3&&checkVar6)===true && enemySet9===false && feld9===false){
      app9.innerHTML = "O"
      enemySet9=true;
      validateWinPC()
    }

    else if((checkVar4&&checkVar7)===true && enemySet1===false && feld1===false){
      app1.innerHTML = "O"
      enemySet1=true;
      validateWinPC()
    }

    else if((checkVar5&&checkVar8)===true && enemySet2===false && feld2===false){
      app2.innerHTML = "O"
      enemySet2=true;
      validateWinPC()
    }
    else if((checkVar6&&checkVar9)===true && enemySet3===false && feld3===false){
      app3.innerHTML = "O"
      enemySet3=true;
      validateWinPC()
    }

    else if((checkVar2&&checkVar3)===true && enemySet1===false && feld1===false){
      app1.innerHTML = "O"
      enemySet1=true;
      validateWinPC()
    }

    else if((checkVar8&&checkVar9)===true && enemySet7===false && feld7===false){
      app7.innerHTML = "O"
      enemySet7=true;
      validateWinPC()
    }
    else if((checkVar5&&checkVar6)===true && enemySet4===false && feld4===false){
      app4.innerHTML = "O"
      enemySet4=true;
      validateWinPC()
    }
    else if((checkVar1&&checkVar5)===true && enemySet9===false && feld9===false){
      app9.innerHTML = "O"
      enemySet9=true;
      validateWinPC()
    }
    else if((checkVar5&&checkVar9)===true && enemySet1===false && feld1===false){
      app1.innerHTML = "O"
      enemySet1=true;
      validateWinPC()
    }
    else if((checkVar3&&checkVar5)===true && enemySet7===false && feld7===false){
      app7.innerHTML = "O"
      enemySet7=true;
      validateWinPC()
    }
    else if((checkVar8&&checkVar5)===true && enemySet3===false && feld3===false){
      app3.innerHTML = "O"
      enemySet3=true;
      validateWinPC()
    }
